...
// ── 🎖️ Insigne / Milestone-uri — apar automat la praguri, fără intervenție manuală ──
...
function openStartMatch(){
    ...
    document.getElementById('startMatchBody').innerHTML =
        `<div style="font-size:.72rem;color:#7d6849;margin-bottom:12px;">Mod: <strong style="color:${has3?'#8e3a9e':'#1554b3'};">${has3?'3️⃣ Trei Echipe':'👥 Două Echipe'}</strong></div>`
